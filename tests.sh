...
curl -X POST -H "Content-Type: application/json" -H "Authorization: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjcxODA5MzIsIlVzZXJJRCI6IjQwMzIxMzg5LTU2ZmQtNGFjMi05YzI4LWU0NTMzYTU5MDdmYiIsIkxvZ2luIjoiZXhhbXBsZSJ9.Hu1q7seneAOdraDS4AtlH6tdC4ooltox6kqpjcGMQCc" -d '{"order": 1115, "sum": 10}' http://127.0.0.1:8081/api/user/balance/withdraw -v
